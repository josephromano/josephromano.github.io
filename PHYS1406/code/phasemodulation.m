...
%
% combine carrier and signal waves using phase
% modulation
%
% y(t) = A_c sin(2pi f_c t + phi_c + x_m(t) )
% 
% where 
%
...
function amp1slider_callback(hObject,eventdata)
  ...
  y = a1*sin(2*pi*f1*t + phi1*pi/180 + y2);
  ...
  legend('y=A_c sin(2\pi f_ct+\phi_c+y_m)', 'location', 'northeast')
