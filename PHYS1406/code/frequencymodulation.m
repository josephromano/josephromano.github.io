...
%
% combine carrier and signal waves using frequency
% modulation
%
% y(t) = A_c sin(2pi f_c t + 2pi\int x_m(t) dt + phi_c)
% 
% where 
%
...
function amp1slider_callback(hObject,eventdata)
  ...
  inty2 = -(a2/(2*pi*f2)) * cos(2*pi*f2*t + phi2*pi/180); 
  y = a1*sin(2*pi*f1*t + 2*pi*inty2 + phi1*pi/180);
