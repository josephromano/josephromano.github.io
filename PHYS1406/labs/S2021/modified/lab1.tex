...
Pulling down slightly on the spring, we let go, and record the time for ten 
...
but also the frequency spectrum from the vibrating string. 
...
%
\ben
\i How does the period change with increasing mass? Is this similar or 
different from the spring?

\i How does the fundamental frequency (pitch) change as the mass increases?
\een

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Pythagorean Intervals and String Division}

For the last part, we use the sonometer again and divide its 
strings with a wedge.
We move the wedge under the string.
We pluck the two sections of the string and listen when the two
resulting tones sound consonant.
We do this for three different string divisions.
...
\i What musical intervals do these ratios correspond to?
\een
