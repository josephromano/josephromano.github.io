...
frequency as in Figure~\ref{f:7} or Figure~\ref{f:8},
for a 0.75-liter wine bottle.
...
at top of the bottle neck take $0.61 r_{\rm avg}$, 
...
for a 1-liter and 2-liter wine bottle, assuming the only thing 
that changes is the volume $V$ of the bottle.
