...
if ientryE < 0 || ientryE >=  ephemE.nentries
      disp('Problem with Earth ephemeris data.');
      earth = 0;
      return;
end

if ientryS < 0 || ientryS >=  ephemS.nentries
      disp('Problem with Sun ephemeris data.');
      earth = 0;
      return;
end
...
leapsSince2000 = GPS_leap_seconds( tGPS.s );
if leapsSince2000 == -1
    disp('Error calculating leap seconds');
    earth = 0;
    return;
end
leapsSince2000 = leapsSince2000 - 13;
