function detector = getdetectorNew(site)
%
...
switch site
  ...
  case 'default'
    ...
    xarm = createorientation(90, 0); % points east
    yarm = createorientation(0, 0);  % points north
  ...
  case 'aL1'
    % antipodal LIGO Livinston 4km (Livingston, Louisiana, USA)
  ...
  case 'aH1'
    % antipodal LIGO Hanford 4km (Hanford, Washington, USA)
  ...
  case 'aV1'
    % antipodal VIRGO (Cascina/Pisa, Italy)
  ...
  case 'T1' 
    % TAMA-300 (Tokyo, Japan) or Kagra (tentative)
  ...
  case 'aK1'
    % antipodal LCGT, Japan from Schutz, CQG 28 125023 (2011)
  ...
  case 'aI1'
    % antipodal LIGO-India from Schutz, CQG 28 125023 (2011)
  ...
  case 'A1'
    % Australia from Schutz, CQG 28 125023 (2011)

    loc  = createlocation(-(31 + (21 + 29/60)/60) , ...
                          115 + (42 + 51/60)/60 , ...
                          90);
    ...
    % from sanjit, below
    %Det.lambda = [115 42 50]*[1; 1/60; 1/3600];
    %Det.phi = [-31 21 29]*[1; 1/60; 1/3600];
    %Det.psi = [180 00 00]*[1; 1/60; 1/3600];
  ...
  case 'aA1'
    % antipodal Australia from Schutz, CQG 28 125023 (2011)
