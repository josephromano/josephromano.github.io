...
#hcross_sim = 1.0+np.cos(tp[0])
#hplus_sim = np.sqrt(3.0*np.cos(tp[0])**2.)
#hcross_sim = np.sqrt(3.0*np.cos(tp[0])**2.)

hplus_sim = ss.sph_harm(0,1,tp[1],tp[0]).real
hcross_sim = ss.sph_harm(0,1,tp[1],tp[0]).real
...
#plt.show()
plt.savefig('JoeData_inject_hplus_real.png')
hp.mollview(hplus_sim.imag)
#plt.show()
plt.savefig('JoeData_inject_hplus_imag.png')
hp.mollview(hcross_sim.real)
#plt.show()
plt.savefig('JoeData_inject_hcross_real.png')
hp.mollview(hcross_sim.imag)
#plt.show()
plt.savefig('JoeData_inject_hcross_imag.png')

hp.mollview((hplus_sim*np.conj(hplus_sim)).real + (hcross_sim*np.conj(hcross_sim)).real)
plt.savefig('JoeData_inject_power.png')
...
#plt.show()
plt.savefig('JoeData_recover_hplusML_real.png')
hp.mollview(hplus_ML.imag)
#plt.show()
plt.savefig('JoeData_recover_hplusML_imag.png')
hp.mollview(hcross_ML.real)
#plt.show()
plt.savefig('JoeData_recover_hcrossML_real.png')
hp.mollview(hcross_ML.imag)
#plt.show()
plt.savefig('JoeData_recover_hcrossML_imag.png')


hp.mollview((hplus_ML*np.conj(hplus_ML)).real + (hcross_ML*np.conj(hcross_ML)).real)
plt.savefig('JoeData_MLrecovered_power.png')
