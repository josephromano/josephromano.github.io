...
(i) Two coaxial solenoids with the shorter, narrower solenoid 
(length $l_1$, radius $a_1$, and number of turns $N_1$) 
sitting inside the  longer, wider solenoid 
(length $l_2$, radius $a_2$, and number of turns $N_2$).
One should find 
$M = \mu_0 n_1 n_2\, l_1\,\pi a_1^2$.
(For this problem, it is simplest to calculate
$M_{12}$ since the flux through the solenoid 1 is uniform.
This is not the case for the flux through solenoid 2.)
